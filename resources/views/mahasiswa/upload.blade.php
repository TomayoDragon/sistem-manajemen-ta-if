<x-mahasiswa-layout>
    ...
    <style>
        /* ... (style .form-group, .btn-submit, dll. tetap sama) ... */
        ...
        .status-box {
            ...
            justify-content: center; border: 2px dashed;
        ...
        /* ... (style .history-table tetap sama) ... */
        ...
        @elseif ($pengajuanTerbaru && $pengajuanTerbaru->status_validasi == 'TERIMA')
            ...
            <div class="status-box accept-box">
                ...
                <p>
                    ...
                    telah disetujui oleh Staf PAJ pada {{ \Carbon\Carbon::parse($pengajuanTerbaru->validated_at)->format('d M Y') }}.
                    <br>
                    Anda tidak dapat mengupload berkas lagi. Silakan lanjut ke halaman "Sidang / LSTA" untuk info jadwal.
                </p>
            </div>
        @else
            ...
            @if ($pengajuanTerbaru && $pengajuanTerbaru->status_validasi == 'TOLAK')
                <div class="status-box reject-box">
                    ...
                    <p>
                        Pengajuan Anda pada {{ $pengajuanTerbaru->created_at->format('d M Y') }} ditolak.
                        Harap perbaiki dan kirimkan ulang seluruh paket berkas Anda.
                    </p>
                    <div class="notes">
