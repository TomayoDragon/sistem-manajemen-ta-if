<x-dynamic-component :component="$layout">
    ...
    <style>
        ...
        .hash-value { 
            font-family: monospace; font-size: 1.1rem; word-break: break-all; 
            padding: 10px; background: #f4f4f4; border-radius: 5px;
        }
        .form-input { 
...
<h1 class="content-title">Verifikasi Integritas Dokumen</h1>
    ...
    <div class="content-box">
        <div class="check-box">
            ...
            <div class="hash-label">Hash Gabungan (SHA-512 + SHA3-512):</div>
